...
class AboutPage(WindowDragMixin, QWidget):
    """Экран «About»: лого, версия, проверка обновлений, разработчик."""
    ...
    def _build(self):
        ...
        bw = max(fm.horizontalAdvance(tr("Check for Updates")),
                 fm.horizontalAdvance(tr("Download Update"))) + s(32)
